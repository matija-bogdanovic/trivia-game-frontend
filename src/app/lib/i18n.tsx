...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'arena.duel.result': 'Duel',
    'arena.duel.won': '{name} takes it',
    'arena.duel.nobody': 'Nobody took it',
    'arena.duel.raceTimes': 'Time to answer',
    'arena.duel.seconds': '{n} s',
    'arena.duel.faster': 'Faster',
    'arena.duel.noAnswer': 'No answer',
    'arena.duel.wrong': 'Wrong',
    'arena.duel.beat':
      '{winner} answered in {fast} s — {loser} needed {slow} s.',
    ...
    'arena.bet.less': 'Lower the stake',
    'arena.bet.more': 'Raise the stake',
    ...
    'arena.game.youWon': 'You won {amount}',
    'arena.game.youLost': 'You lost {amount}',
    ...
    'arena.home.noFriendsOnline': 'None of your friends are online',
    'arena.home.noFriendsYet': "You don't have any friends yet",
    'arena.home.addFriend': 'Add friend',
    'arena.home.playMatch': 'Play a match',
    'arena.common.cancel': 'Cancel',
    'arena.common.close': 'Close',
    'arena.lobby.hostChanged': '{name} is the host now',
    'arena.lobby.hostChangedYou': 'You are the host now',
    'arena.lobby.hostLeftWhy': 'The previous host left the room.',
    ...
    'arena.notif.empty': 'Nothing here yet',
    'arena.notif.markAll': 'Mark all read',
    'arena.notif.invite': '{name} invited you to a room',
    'arena.notif.unknown': 'Something happened',
    'arena.notif.justNow': 'just now',
    'arena.notif.minutes': '{n} min ago',
    'arena.notif.hours': '{n} h ago',
    'arena.notif.days': '{n} d ago',
    'arena.invite.banner': '{name} is inviting you to a room',
    'arena.invite.join': 'Join',
    'arena.invite.decline': 'Decline',
    'arena.invite.title': 'Invite a friend',
    'arena.invite.open': 'Invite friend',
    'arena.invite.send': 'Invite',
    'arena.invite.sent': 'Invited',
    'arena.invite.inRoom': 'In this room',
    ...
    'arena.invite.err.generic': 'Could not send that invite.',
    'arena.pw.title': 'Change password',
    'arena.pw.current': 'Current password',
    'arena.pw.new': 'New password',
    'arena.pw.repeat': 'Repeat new password',
    'arena.pw.submit': 'Change password',
    'arena.pw.saving': 'Changing…',
    'arena.pw.done': 'Password changed',
    'arena.pw.sameAsOld': 'The new password is the same as the current one.',
    'arena.pw.wrongCurrent': 'That is not your current password.',
    'arena.pw.tooMany': 'Too many attempts. Wait a few minutes and try again.',
    'arena.pw.expired':
      'Your session expired. Sign in again to change your password.',
    'arena.pw.google':
      'This account signs in with Google, so it has no password here.',
    'arena.player.title': 'Player',
    'arena.player.viewProfile': "View {name}'s profile",
    'arena.player.noStats': 'This player has not finished a match yet.',
    ...
    'arena.nav.main': 'Main',
    'arena.rules.eyebrow': 'The game',
    'arena.rules.play': 'Play a match',
    'arena.nav.rules': 'How to play',
    'arena.nav.home': 'Home',
    ...
    'arena.lb.openSpot': 'Open spot',
    'arena.lb.openSpotSr': 'No player in {n} place yet',
  ...
  sr: {
    ...
    'arena.duel.result': 'Dvoboj',
    'arena.duel.won': '{name} pobeđuje',
    'arena.duel.nobody': 'Niko nije pobedio',
    'arena.duel.raceTimes': 'Vreme za odgovor',
    'arena.duel.seconds': '{n} s',
    'arena.duel.faster': 'Brži',
    'arena.duel.noAnswer': 'Bez odgovora',
    'arena.duel.wrong': 'Netačno',
    'arena.duel.beat':
      '{winner} je odgovorio za {fast} s — {loser} je trebalo {slow} s.',
    ...
    'arena.bet.less': 'Manji ulog',
    'arena.bet.more': 'Veći ulog',
    'arena.bet.allIn': 'Sve',
    ...
    'arena.game.youWon': 'Dobio si {amount}',
    'arena.game.youLost': 'Izgubio si {amount}',
    ...
    'arena.home.noFriendsOnline': 'Nijedan prijatelj nije onlajn',
    'arena.home.noFriendsYet': 'Trenutno nemate nijednog prijatelja',
    'arena.home.addFriend': 'Dodaj prijatelja',
    'arena.home.playMatch': 'Igraj partiju',
    'arena.common.cancel': 'Otkaži',
    'arena.common.close': 'Zatvori',
    'arena.lobby.hostChanged': '{name} je sada domaćin',
    'arena.lobby.hostChangedYou': 'Ti si sada domaćin',
    'arena.lobby.hostLeftWhy': 'Prethodni domaćin je napustio sobu.',
    ...
    'arena.notif.empty': 'Još ništa ovde',
    'arena.notif.markAll': 'Označi sve',
    'arena.notif.invite': '{name} te poziva u sobu',
    'arena.notif.unknown': 'Nešto se desilo',
    'arena.notif.justNow': 'upravo sada',
    'arena.notif.minutes': 'pre {n} min',
    'arena.notif.hours': 'pre {n} h',
    'arena.notif.days': 'pre {n} d',
    'arena.invite.banner': '{name} te poziva u sobu',
    'arena.invite.join': 'Pridruži se',
    'arena.invite.decline': 'Odbij',
    'arena.invite.title': 'Pozovi prijatelja',
    'arena.invite.open': 'Pozovi prijatelja',
    'arena.invite.send': 'Pozovi',
    'arena.invite.sent': 'Pozvan',
    'arena.invite.inRoom': 'U ovoj sobi',
    ...
    'arena.invite.err.generic': 'Slanje poziva nije uspelo.',
    'arena.pw.title': 'Promena lozinke',
    'arena.pw.current': 'Trenutna lozinka',
    'arena.pw.new': 'Nova lozinka',
    'arena.pw.repeat': 'Ponovi novu lozinku',
    'arena.pw.submit': 'Promeni lozinku',
    'arena.pw.saving': 'Menjam…',
    'arena.pw.done': 'Lozinka je promenjena',
    'arena.pw.sameAsOld': 'Nova lozinka je ista kao trenutna.',
    'arena.pw.wrongCurrent': 'To nije tvoja trenutna lozinka.',
    'arena.pw.tooMany':
      'Previše pokušaja. Sačekaj par minuta pa probaj ponovo.',
    'arena.pw.expired':
      'Sesija je istekla. Prijavi se ponovo da bi promenio lozinku.',
    'arena.pw.google':
      'Ovaj nalog se prijavljuje preko Google-a, pa ovde nema lozinku.',
    'arena.player.title': 'Igrač',
    'arena.player.viewProfile': 'Pogledaj profil igrača {name}',
    'arena.player.noStats': 'Ovaj igrač još nije odigrao nijednu partiju.',
    ...
    'arena.rules.eyebrow': 'Igra',
    'arena.rules.play': 'Igraj partiju',
    'arena.nav.rules': 'Kako se igra',
    ...
    'arena.lb.openSpot': 'Slobodno mesto',
    'arena.lb.openSpotSr': 'Još nema igrača na {n}. mestu',
