...
/** A trophy — a podium place. (Phosphor `Trophy`, regular) */
...
/** A smiling face — an empty list, nothing here yet. (Phosphor `Smiley`, regular) */
...
/** A sad face — something that is not available yet. (Phosphor `SmileySad`, regular) */
export function SmileySadIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg
      viewBox="0 0 256 256"
      className={className}
...
/** A globe — a public room, open to anyone. (Phosphor `Globe`, regular) */
...
/** A padlock — a private room, code and password only. (Phosphor `Lock`, regular) */
...
/** An eye struck through — the password is showing; click to hide it. (Phosphor `EyeSlash`, regular) */
...
/** A cross — decline, remove, dismiss. (Phosphor `X`, regular) */
...
/** A caret — a section that opens; rotate it 180 when it is open. (Phosphor `CaretDown`, regular) */
...
/** An hourglass — a match still running, waiting to be rejoined. (Phosphor `Hourglass`, regular) */
export function HourglassIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg
      viewBox="0 0 256 256"
      className={className}
...
/** A door with an arrow leaving it — sign out. (Phosphor `SignOut`, regular) */
...
/** A sword — a duel. Phosphor has no `Swords`; the single blade is the whole family. (Phosphor `Sword`, regular) */
export function SwordIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg
      viewBox="0 0 256 256"
      className={className}
...
/** Stacked coins — money a player starts with or holds. (Phosphor `Coins`, regular) */
...
/** A rising line — difficulty that climbs as the chain grows. (Phosphor `TrendUp`, regular) */
...
/** A calendar with a cross through it — no matches on record. (Phosphor `CalendarX`, regular) */
export function CalendarXIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg
      viewBox="0 0 256 256"
      className={className}
...
/** Three people — a friends list, or the absence of one. (Phosphor `UsersThree`, regular) */
export function UsersThreeIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg
      viewBox="0 0 256 256"
      className={className}
...
/** Two stacked sheets — copy to the clipboard. (Phosphor `Copy`, regular) */
...
/** A drop — first blood. (Phosphor `Drop`, regular) */
export function DropIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg
      viewBox="0 0 256 256"
      className={className}
...
/** An open book — the rules, for reading. (Phosphor `BookOpen`, regular) */
...
/** A bell — notifications. (Phosphor `Bell`, regular) */
...
/**
 * Unstoppable — a run that will not stop. Supplied art, 32 viewBox.
 *
 * SUPPLIED, not from @phosphor-icons/core — so verify_icons.mjs cannot check
 * it against upstream, and the marker below tells it to say so rather than
 * fail. It also keeps the 32 viewBox it arrived in: the coordinates are in
 * 32 units, and rescaling them by hand is exactly the kind of edit that
 * produced the truncated icons this file's header warns about.
 *
 * The fill moves from the exporter's #343330 to currentColor so it themes;
 * fill="none" stays on the root, where it only reaches elements that have no
 * fill of their own — which is nothing here.
 */
/* @icon-source: supplied */
export function UnstoppableIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg
      viewBox="0 0 32 32"
      className={className}
    ...
    >
      <path
        d="M27.7338 10.395C29.1215 13.2973 29.3849 16.6107 28.4733 19.6957C27.5616 22.7808 25.5395 25.4188 22.7972 27.1006C20.055 28.7825 16.7869 29.3889 13.6238 28.8029C10.4607 28.2169 7.62675 26.4799 5.66897 23.9274C3.71118 21.3748 2.76831 18.1874 3.02235 14.9805C3.27638 11.7737 4.7093 8.77454 7.04455 6.56201C9.37981 4.34949 12.4518 3.08041 15.6678 2.9997C18.8837 2.919 22.0155 4.0324 24.4588 6.12501L27.2926 3.29001C27.4802 3.10237 27.7347 2.99695 28.0001 2.99695C28.2654 2.99695 28.5199 3.10237 28.7076 3.29001C28.8952 3.47765 29.0006 3.73215 29.0006 3.99751C29.0006 4.26287 28.8952 4.51737 28.7076 4.70501L16.7076 16.705C16.5199 16.8927 16.2654 16.9981 16.0001 16.9981C15.7347 16.9981 15.4802 16.8927 15.2926 16.705C15.1049 16.5174 14.9995 16.2629 14.9995 15.9975C14.9995 15.7321 15.1049 15.4776 15.2926 15.29L18.7576 11.825C17.8185 11.204 16.6973 10.918 15.5755 11.0134C14.4537 11.1089 13.397 11.5801 12.5763 12.3509C11.7557 13.1217 11.2192 14.1469 11.0537 15.2605C10.8882 16.3741 11.1034 17.511 11.6645 18.4871C12.2255 19.4632 13.0996 20.2214 14.1451 20.6389C15.1907 21.0564 16.3466 21.1089 17.4257 20.7877C18.5047 20.4666 19.4438 19.7906 20.091 18.8693C20.7381 17.948 21.0553 16.8353 20.9913 15.7113C20.9839 15.5799 21.0025 15.4484 21.0459 15.3243C21.0893 15.2001 21.1568 15.0858 21.2444 14.9877C21.3321 14.8896 21.4382 14.8097 21.5567 14.7527C21.6752 14.6956 21.8037 14.6624 21.9351 14.655C22.2003 14.6401 22.4606 14.7311 22.6586 14.9081C22.7567 14.9958 22.8366 15.1019 22.8937 15.2204C22.9507 15.3389 22.9839 15.4674 22.9913 15.5988C23.0825 17.1897 22.6281 18.7642 21.7032 20.0619C20.7783 21.3596 19.4383 22.3029 17.9046 22.7359C16.371 23.1689 14.7355 23.0656 13.2686 22.4431C11.8016 21.8207 10.5909 20.7163 9.83658 19.3125C9.08229 17.9088 8.82955 16.2897 9.12014 14.7228C9.41073 13.1559 10.2272 11.7351 11.4347 10.6952C12.6422 9.65523 14.1684 9.05843 15.761 9.0034C17.3537 8.94837 18.9174 9.4384 20.1938 10.3925L23.0376 7.54876C20.9536 5.8185 18.3038 4.91921 15.5971 5.0236C12.8905 5.128 10.3178 6.22871 8.3733 8.11434C6.42876 9.99997 5.24945 12.5376 5.06187 15.2397C4.87429 17.9419 5.69167 20.6181 7.35701 22.7543C9.02236 24.8905 11.4182 26.3361 14.0845 26.8135C16.7508 27.2909 19.4994 26.7663 21.8025 25.3406C24.1056 23.9149 25.8007 21.6886 26.5623 19.0892C27.3239 16.4898 27.0983 13.7007 25.9288 11.2575C25.8144 11.0182 25.7998 10.7432 25.8882 10.493C25.9766 10.2429 26.1607 10.0381 26.4001 9.92376C26.6394 9.80938 26.9144 9.79478 27.1645 9.88316C27.4147 9.97153 27.6194 10.1557 27.7338 10.395Z"
        fill="currentColor"
      />
    </svg>
  );
...
/**
 * Veteran — a medal on its ribbon. Supplied art, 32 viewBox.
 *
 * SUPPLIED, not from @phosphor-icons/core — so verify_icons.mjs cannot check
 * it against upstream, and the marker below tells it to say so rather than
 * fail. It also keeps the 32 viewBox it arrived in: the coordinates are in
 ...
 */
/* @icon-source: supplied */
export function VeteranIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg
      viewBox="0 0 32 32"
      className={className}
    ...
    >
      <path
        d="M27 12C27.0011 10.1463 26.5337 8.32229 25.6412 6.69753C24.7487 5.07277 23.4601 3.69991 21.895 2.70646C20.33 1.71302 18.5392 1.13121 16.6891 1.01508C14.839 0.898948 12.9896 1.25226 11.3125 2.0422C9.63553 2.83215 8.18535 4.0331 7.0967 5.5335C6.00805 7.03391 5.31624 8.78511 5.08553 10.6244C4.85482 12.4638 5.09268 14.3316 5.77704 16.0544C6.4614 17.7772 7.57004 19.2991 9 20.4788V30C8.99988 30.1705 9.04338 30.3383 9.12636 30.4873C9.20934 30.6363 9.32905 30.7616 9.4741 30.8513C9.61916 30.941 9.78474 30.9921 9.95511 30.9997C10.1255 31.0074 10.295 30.9713 10.4475 30.895L16 28.125L21.5538 30.9013C21.693 30.9679 21.8457 31.0017 22 31C22.2652 31 22.5196 30.8946 22.7071 30.7071C22.8946 30.5196 23 30.2652 23 30V20.4788C24.2512 19.4483 25.2587 18.1536 25.9503 16.6877C26.6419 15.2217 27.0003 13.6209 27 12ZM7 12C7 10.22 7.52784 8.47991 8.51677 6.99987C9.50571 5.51983 10.9113 4.36627 12.5559 3.68509C14.2004 3.0039 16.01 2.82567 17.7558 3.17293C19.5016 3.5202 21.1053 4.37737 22.364 5.63604C23.6226 6.89471 24.4798 8.49836 24.8271 10.2442C25.1743 11.99 24.9961 13.7996 24.3149 15.4442C23.6337 17.0887 22.4802 18.4943 21.0001 19.4832C19.5201 20.4722 17.78 21 16 21C13.6139 20.9974 11.3262 20.0483 9.63896 18.361C7.95171 16.6738 7.00265 14.3861 7 12ZM21 28.3825L16.4463 26.1063C16.3073 26.0367 16.1541 26.0005 15.9988 26.0005C15.8434 26.0005 15.6902 26.0367 15.5513 26.1063L11 28.3825V21.7963C12.548 22.5874 14.2616 23 16 23C17.7384 23 19.452 22.5874 21 21.7963V28.3825ZM16 19C17.3845 19 18.7378 18.5895 19.889 17.8203C21.0401 17.0511 21.9373 15.9579 22.4672 14.6788C22.997 13.3997 23.1356 11.9922 22.8655 10.6344C22.5954 9.2765 21.9287 8.02922 20.9497 7.05025C19.9708 6.07129 18.7235 5.4046 17.3656 5.1345C16.0078 4.86441 14.6003 5.00303 13.3212 5.53284C12.0421 6.06266 10.9489 6.95987 10.1797 8.11101C9.41054 9.26215 9 10.6155 9 12C9.00199 13.8559 9.74012 15.6352 11.0524 16.9476C12.3648 18.2599 14.1441 18.998 16 19ZM16 7C16.9889 7 17.9556 7.29325 18.7779 7.84265C19.6001 8.39206 20.241 9.17295 20.6194 10.0866C20.9978 11.0002 21.0969 12.0055 20.9039 12.9755C20.711 13.9454 20.2348 14.8363 19.5355 15.5355C18.8363 16.2348 17.9454 16.711 16.9755 16.9039C16.0055 17.0969 15.0002 16.9978 14.0866 16.6194C13.173 16.241 12.3921 15.6001 11.8427 14.7779C11.2932 13.9556 11 12.9889 11 12C11 10.6739 11.5268 9.40215 12.4645 8.46447C13.4021 7.52679 14.6739 7 16 7Z"
        fill="currentColor"
      />
    </svg>
  );
...
/** A poker chip — a bet. (Phosphor `PokerChip`, regular) */
export function PokerChipIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg
      viewBox="0 0 256 256"
      className={className}
