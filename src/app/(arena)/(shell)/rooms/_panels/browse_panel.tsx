    ...
    <div>
      ...
      */}
      <div className="mb-8 flex flex-wrap gap-3 sm:gap-4">
        ...
        <Link
          href="/rooms/create"
          className="inline-flex items-center gap-2 rounded-lg border border-white/20 px-6 py-3 text-[11px] font-bold tracking-[0.2em] text-white uppercase transition-colors hover:bg-arena-700 focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none"
        >
      ...
      */}
      {gone && (
        <div
          className="mb-6 rounded-lg border border-gold/30 bg-gold/10 px-4 py-3 text-[12px] text-gold"
          role="status"
        >
          {t('arena.rooms.gone')}
        </div>
      ...
      {/* ========================================================== filters */}
      <div className="mb-6 flex flex-col gap-4 rounded-lg border border-white/[0.07] bg-arena-800 p-4 xl:flex-row xl:flex-wrap xl:items-center">
        ...
        */}
        <div className="relative w-full xl:w-72">
          ...
          <input
            ...
            className="w-full rounded-lg border border-white/10 bg-arena-750 py-2 pr-4 pl-10 text-sm text-white outline-none placeholder:text-arena-300 focus:border-gold/40"
          />
        </div>
        ...
        <button
          ...
          className="cursor-pointer rounded-lg border border-white/10 px-3 py-2 text-[10px] tracking-wider text-arena-200 uppercase transition-colors hover:border-arena-300 hover:text-white focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none"
        >
        ...
        <select
          ...
          className="cursor-pointer rounded-lg border border-white/10 bg-arena-750 px-3 py-2 text-[10px] tracking-wider text-arena-200 uppercase outline-none focus:border-gold/40 xl:ml-auto"
        >
      ...
      {error && (
        <div className="mb-4 rounded-lg border border-gold/40 bg-gold/10 px-4 py-3 text-[12px] text-gold">
          {error}
        </div>
      )}
      ...
      */}
      {loading && (
        <SkeletonRegion className="grid gap-4 xl:grid-cols-2">
          {Array.from({ length: 4 }, (_, i) => (
            <div
              key={i}
              className="rounded-lg border border-white/[0.07] bg-arena-800 p-5"
            >
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        {visible.map((room) => (
          <article
            key={room.lobbyId}
            className="rounded-lg border border-white/[0.07] bg-arena-800 p-5 transition-colors hover:bg-arena-750"
          >
            <div className="mb-4 flex items-start justify-between gap-3">
              ...
              */}
              {room.status === 'playing' && room.spectateEnabled !== false && (
                <span
                  className="flex shrink-0 items-center gap-1 rounded-lg border border-frost/40 px-2 py-1 text-[10px] tracking-wider text-frost uppercase"
              ...
              */}
              <div
                className={`flex shrink-0 items-center gap-1.5 rounded-lg border px-2 py-1 text-[10px] tracking-wider uppercase ${
                  room.isPrivate
            ...
            <div className="mb-4 grid grid-cols-2 gap-3">
              ...
              */}
              <div>
                ...
                <span
                  className={`inline-flex items-center gap-1.5 rounded-lg border px-2 py-1 text-[10px] tracking-wider uppercase ${
                    room.status === 'playing'
