    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <Section label={t('arena.create.roomName')} htmlFor="room-name">
        <input
          ...
          className="bg-arena-750 rounded-lg border border-white/10 text-white text-xl font-bold tracking-widest px-5 py-4 w-full outline-none focus:border-gold/40 placeholder:text-arena-400 uppercase"
        ...
        >
          ...
          */}
          <button
            ...
            disabled={creating}
            className={`cursor-pointer rounded-lg border px-3 py-2 text-[11px] font-bold tracking-wider uppercase transition-colors focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none ${
              everyCategory
            ...
            */
            ...
            return (
              <button
                ...
                disabled={creating}
                className={`cursor-pointer rounded-lg border px-3 py-2 text-[11px] tracking-wider uppercase transition-colors focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none ${
                  selected
        ...
        >
          {CAPACITIES.map((n) => (
            <button
              ...
              disabled={creating}
              className={`w-12 cursor-pointer rounded-lg border py-2 text-sm font-bold tabular-nums transition-colors focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none ${
                maxPlayers === n
                  ? 'border-gold bg-gold text-arena-950'
                  : 'border-white/10 text-arena-200 hover:border-arena-300 hover:text-white'
              }`}
      ...
      {error && (
        <div className="bg-arena-800 rounded-lg border border-gold/40 text-arena-100 text-sm px-4 py-3">
          {error}
        </div>
      )}
      ...
      <div className="flex flex-wrap gap-4 pt-2">
        ...
        <Link
          href="/home"
          className="rounded-lg border border-white/20 text-white text-[11px] tracking-[0.15em] uppercase px-6 py-4 hover:bg-arena-700 transition-colors"
        >
