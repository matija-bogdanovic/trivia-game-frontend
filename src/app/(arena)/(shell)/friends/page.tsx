            ...
            */}
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/10 bg-arena-800 py-3 pr-4 pl-10 text-sm text-white outline-none placeholder:text-arena-400 focus:border-gold/40"
              />
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <input
              ...
              className="mb-3 w-full rounded-lg border border-white/10 bg-arena-750 px-3 py-2.5 text-sm text-white outline-none placeholder:text-arena-400 focus:border-gold/40"
            />
            <button
              type="submit"
          ...
          {/* requests */}
          {requests.length > 0 && (
            <section className="rounded-lg border border-white/[0.07] bg-arena-800 p-5">
              <h2 className="mb-4 text-[10px] tracking-[0.25em] text-arena-200 uppercase">
                ...
                {requests.map((request) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="cursor-pointer rounded-lg border border-gold/40 px-2 py-1 text-[10px] text-gold transition-colors hover:bg-gold/10 focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none"
                    ...
                    <button
                      ...
                      className="cursor-pointer rounded-lg border border-arena-400 px-2 py-1 text-[10px] text-arena-300 transition-colors hover:border-arena-300 focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none"
...
function FriendRow({
  ...
  return (
    <div className="flex items-center gap-4 rounded-lg border border-white/[0.07] bg-arena-800 p-4 transition-colors hover:bg-arena-750">
      {/*
      ...
      */}
      ...
      {friend.online ? (
        ...
        <button
          type="button"
          onClick={() => onOpen(cardFor(friend))}
          className="cursor-pointer rounded-lg border border-arena-400 px-4 py-2 text-[10px] tracking-[0.15em] text-arena-300 uppercase transition-colors hover:border-arena-300 hover:text-white focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none"
