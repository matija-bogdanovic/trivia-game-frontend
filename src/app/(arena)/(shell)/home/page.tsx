...
export default function Page() {
  ...
  return (
    <div className="space-y-8 p-4 sm:p-6 lg:p-8">
      ...
      */}
      <section
        className="relative overflow-hidden rounded-lg border border-white/[0.07] p-6 sm:p-10"
        style={{
          background:
        ...
        <div className="relative">
          ...
          */}
          <div className="flex flex-wrap gap-x-3 gap-y-5 sm:gap-x-4">
            ...
            <Link
              href="/rooms/join"
              className="rounded-lg border border-white/20 px-6 py-4 text-sm font-bold tracking-[0.15em] text-white uppercase transition-colors hover:bg-arena-700 focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none sm:px-8"
            >
        ...
        <section className="space-y-4 lg:col-span-3">
          ...
          */}
          {!loading && signedIn && recentMatches.length === 0 && (
            <div className="rounded-lg border border-white/[0.07] bg-arena-800 px-4 py-10 text-center">
          ...
          */}
          {recentMatches.map((match) => (
            <Link
              key={match.matchId}
              href="/history"
              className="flex items-center gap-4 rounded-lg border border-white/[0.07] bg-arena-800 p-4 transition-colors hover:bg-arena-700 focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none"
            >
              <span
              ...
              <span className="min-w-0 flex-1">
                <span className="mb-0.5 flex items-center gap-2">
                  ...
                  <span className="shrink-0 rounded-lg border border-arena-500 px-1.5 py-0.5 text-[9px] tracking-widest text-arena-300">
        ...
        <section className="space-y-4 lg:col-span-2">
          ...
          */}
          {friends !== null && onlineFriends.length === 0 && (
            <div className="rounded-lg border border-white/[0.07] bg-arena-800 px-4 py-8 text-center">
              <div className="mb-3 flex justify-center" aria-hidden="true">
              ...
              {friends.length === 0 && (
                <Link
                  ...
                  className="mt-4 inline-flex items-center gap-2 rounded-lg border border-gold/40 px-4 py-2 text-[10px] font-bold tracking-[0.2em] text-gold uppercase transition-colors hover:bg-gold/10 focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none"
                >
          ...
          {onlineFriends.map((friend) => {
            ...
            return (
              <div
                key={friend.username}
                className="flex items-center gap-3 rounded-lg border border-white/[0.07] bg-arena-800 p-3"
              >
                {/*
                ...
                */}
                ...
                <button
                  type="button"
                  className="cursor-pointer rounded-lg border border-arena-400 px-2 py-1 text-[10px] tracking-wider text-arena-200 uppercase transition-colors hover:border-arena-300 hover:text-white focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none"
