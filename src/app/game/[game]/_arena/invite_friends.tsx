      ...
      <div className="max-h-72 space-y-2 overflow-y-auto">
        {(friends ?? []).map((friend) => {
          ...
          return (
            <div
              key={friend.username}
              className="flex items-center gap-3 border border-white/[0.07] bg-arena-750 p-3"
            >
              ...
              {already ? (
                ...
                <button
                  ...
                  className={`shrink-0 border px-3 py-1.5 text-[10px] font-bold tracking-[0.15em] uppercase transition-colors focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none ${
                    invitable
