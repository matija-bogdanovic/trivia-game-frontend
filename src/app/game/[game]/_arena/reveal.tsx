...
export default function ArenaReveal() {
  ...
  return (
    <div className="w-full max-w-2xl text-center">
      ...
      <div
        className={`mb-6 border bg-arena-800 p-6 ${lastCorrect ? 'border-gold/20' : 'border-white/[0.07]'}`}
      >
      ...
      {/* ================================================= settled bets */}
      {bets.length > 0 && (
        <div className="mb-6 border border-white/[0.07] bg-arena-800 p-5 text-left">
      ...
      {/* ================================================ pot and minting */}
      <div className="mb-6 grid grid-cols-2 gap-4 border border-white/[0.07] bg-arena-800 p-5 sm:grid-cols-3">
        <div>
      ...
      {eliminated.length > 0 && (
        <div className="border border-gold/30 bg-gold/10 px-4 py-3 text-[11px] tracking-wider text-gold">
