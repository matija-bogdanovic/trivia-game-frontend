...
export default function ArenaBetting() {
  ...
  return (
    <aside className="flex shrink-0 flex-col border-t border-white/[0.07] bg-arena-800 p-5 lg:w-64 lg:border-t-0 lg:border-l">
      ...
      <div className="mb-4 border border-white/[0.07] bg-arena-750 p-3 text-center">
        ...
        <>
          ...
          <div className="mb-4 flex gap-2">
            ...
            <button
              ...
              className="shrink-0 cursor-pointer border border-gold/40 px-3 text-[10px] font-bold tracking-wider text-gold uppercase transition-colors hover:bg-gold/10 disabled:cursor-not-allowed disabled:border-arena-500 disabled:text-arena-500"
            >
              {t('arena.bet.allIn')}
            </button>
          </div>
          ...
          <div className="mb-6 grid gap-3">
            {(['correct', 'wrong'] as const).map((side) => (
              <button
                ...
                disabled={myMoney < MIN_BET}
                className={`w-full border py-3 text-[12px] font-bold tracking-[0.15em] uppercase transition-colors focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none ${
                  myMoney < MIN_BET
          ...
          <button
            ...
            className="mb-4 w-full cursor-pointer border border-white/10 py-2 text-[10px] tracking-[0.2em] text-arena-300 uppercase transition-colors hover:border-arena-300 hover:text-white focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none"
          >
            {t('arena.bet.sitOut')}
          </button>
